...
- Phase 4 (Kimi K2.6 thinking ON): 7タスク完了 (jcommonsenseqa/jemhopqa/jsquad/mgsm/igakuqa119/igakuqa119_official/jmle2026/jmmlu_med、2026-05-01)、残3タスク (igakuqa / crade / rrtnm)
- GLM-5.1 は IgakuQA119 official プロンプト未測 → 再ラン待ち
...
公式LB の 4列形式(Overall + No-Img)。**本検証は公式LB と同じプロンプト形式 (`naoto-iwase/IgakuQA119` `src/llm_solver.py` 準拠、`answer:` 行抽出)** で記載。Llama 系省略、国産は参考:
...
**参考: 独自プロンプト (`<answer>` タグ抽出) での測定値** — 公式LB との直接比較は不可。プロンプト形式の影響を見るため:

| Entry | Overall Score | Overall Acc. | No-Img Score | No-Img Acc. |
|---|---|---|---|---|
| Kimi K2.6 (vision) | 455/500 (91.00%) | 367/400 (91.75%) | 346/383 (90.34%) | 272/297 (91.58%) |
| GLM-5.1 (text-only) ※公式形式で再ラン待ち | - | - | 357/383 (93.21%) | 281/297 (94.61%) |

**観察**:
- Kimi K2.6 (公式形式 vision): Overall 465/500 (93.00%) — Claude-Sonnet-4 (94.20%) と DeepSeek-R1-0528 (92.20%) の間。**Acc は Claude-Sonnet-4 と同点 (375/400)**
- プロンプト形式差: Kimi K2.6 で **公式形式 +10 点 (455→465)** 改善 — `<answer>` タグより `answer:` 行の方が遵守率高い
...
PFN の Preferred-MedLLM-Qwen-72B 論文 ([HF card](https://huggingface.co/pfnet/Preferred-MedLLM-Qwen-72B), [arxiv 2504.18080](https://arxiv.org/abs/2504.18080)) のベンチ表を借用。**5年合計 / 2485点満点**(画像問題はテキストのみで評価):

| Entry | 5年合計 Score | Avg/年 (/497) | 2018 | 2019 | 2020 | 2021 | 2022 |
|---|---:|---:|---:|---:|---:|---:|---:|
| Preferred-MedLLM-Qwen-72B | 2156/2485 (86.76%) | 431.2 | 434 | 420 | 439 | 430 | 433 |
| GPT-4o | 2152/2485 (86.60%) | 430.4 | 427 | 431 | 433 | 427 | 434 |
| Qwen2.5-72B | 1992/2485 (80.16%) | 398.4 | 412 | 394 | 394 | 393 | 399 |
| Llama3-Preferred-MedSwallow-70B | 1976/2485 (79.52%) | 395.2 | 407 | 390 | 391 | 393 | 395 |
| GPT-4 | 1944/2485 (78.23%) | 388.8 | 382 | 385 | 387 | 398 | 392 |
| Mistral-Large-Instruct-2407 | 1880/2485 (75.65%) | 376.0 | 370 | 371 | 390 | 373 | 376 |
| Llama-3.1-Swallow-70B-v0.1 | 1842/2485 (74.13%) | 368.4 | 379 | 378 | 379 | 351 | 355 |
| Meta-Llama-3-70B | 1673/2485 (67.32%) | 334.6 | 353 | 340 | 348 | 314 | 318 |
| GPT-3.5 | 1366/2485 (54.97%) | 273.2 | 266 | 250 | 266 | 297 | 287 |

参考: Kasai+ 2023 paper の素値 (No-Img 1864点ベース、別 scope):
...
**本検証** (画像問題は完全スキップ、No-Img only):

| Entry | No-Img Score | No-Img Acc. |
|---|---|---|
| **GLM-5.1 (本検証 text-only)** | **1742/1864 (93.45%)** | **1368/1471 (93.00%)** |

**注意点**:
- PFN表は **5年合計2485点 (画像問題テキスト評価込み)**、本検証は **No-Img 1864点 (画像問題スキップ)** で **scope が異なる** → 直接比較不可
- 仮に GLM-5.1 が画像問題で得点ゼロでも 1742/2485 (70.1%)、ランダム選択 (20%) で 1868/2485 (75.2%) → PFN表の中位 Llama-3.1-Swallow / Mistral 帯
- ただし **2018-2022 はインターネット上の解説サイトに完全に出回っており、フロンティアモデル(Claude 4系 / GPT-5 / Gemini 2.5+)の事前学習リーク確実視** → publicly な評価値も存在しない (2026-05 時点)
- このベンチは「年次トレンド参考」枠で、最新モデル比較ラインは **IgakuQA119 / JMLE2026** に移している
