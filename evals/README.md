...
|---|---|---|---|
| 必修 (B+E、200点満点) | 191/200 (95.50%) / acc 95/100 (95.00%) | 未実行 | 160点 |
| 一般+臨床 (A+C+D+F、300点満点) | 289/300 (96.33%) | 未実行 | 224点 |
| 必修 (Text-only、168点) | 163/168 (97.02%) / acc 85/88 (96.59%) | 未実行 | — |
| 一般+臨床 (Text-only、214点) | 206/214 (96.26%) | 未実行 | — |

ブロック別正答率:

| ブロック | Kimi K2.6 | GLM-5.1 |
|---|---|---|
| 120A 一般 | 97.3% | 未実行 |
| 120B 必修 | 96.0% | 未実行 |
| 120C 一般 | 93.3% | 未実行 |
