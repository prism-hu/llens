...
|---|---|---|---|
| jcommonsenseqa / jemhopqa / jsquad / mgsm | ✓ | ✓ | ✓ (off+on) |
| igakuqa (2018-2022) | ✓ | ✓ | ✓ (off+on) |
| igakuqa119 | ✓ (vision) | ⚠ 旧 skip 結果、blind 再ラン待ち | ✓ (off+on、blind) |
| jmle2026 | ✓ (vision) | ✓ (blind) | ✓ (off+on、blind) |
| jmmlu_med / crade / rrtnm | ✓ | ✓ | ✓ (off+on) |

- DeepSeek V3.2 は think_on / think_off 両方完走済 (V3.2 のみ default が think_off のためハーネス側で `chat_template_kwargs.thinking=true` を明示送信)
- GLM-5.1 igakuqa119 のみ scope 修正 (skip → blind、LB 流儀準拠) のため再ラン待ち
...
| カテゴリ | Kimi K2.6 (vision) | GLM-5.1 (blind) | V3.2 think_on (blind) | V3.2 think_off (blind) | 合否ライン |
|---|---|---|---|---|---|
| 必修 (B+E、200点満点) | 191/200 (95.50%) | 195/200 (97.50%) | 188/200 (94.00%) | 186/200 (93.00%) | 160点 |
| 一般+臨床 (A+C+D+F、300点満点) | 289/300 (96.33%) | 286/300 (95.33%) | 287/300 (95.67%) | 272/300 (90.67%) | 224点 |
| 必修 (Text-only、168点) | 163/168 (97.02%) | 163/168 (97.02%) | 162/168 (96.43%) | 162/168 (96.43%) | — |
| 一般+臨床 (Text-only、214点) | 206/214 (96.26%) | 207/214 (96.73%) | 208/214 (97.20%) | 196/214 (91.59%) | — |

ブロック別正答率:

| ブロック | Kimi K2.6 (vision) | GLM-5.1 (blind) | V3.2 think_on | V3.2 think_off |
|---|---|---|---|---|
| 120A 一般 | 97.3% | 98.7% | 96.0% | 90.7% |
| 120B 必修 | 96.0% | 96.0% | 94.0% | 90.0% |
| 120C 一般 | 93.3% | 90.7% | 90.7% | 88.0% |
| 120D 一般 | **100.0%** | 97.3% | **100.0%** | 92.0% |
| 120E 必修 | 94.0% | **98.0%** | 98.0% | 94.0% |
| 120F 一般 | 94.7% | 94.7% | 96.0% | 92.0% |
...
| カテゴリ | Kimi K2.6 (vision) | GLM-5.1 (旧 skip) | V3.2 think_on (blind) | V3.2 think_off (blind) |
|---|---|---|---|---|
| 必修 (B+E、200点満点) | 182/200 (91.00%) | 再ラン待ち | 186/200 (93.00%) | 161/200 (80.50%) |
| 一般 (A+C+D+F、300点満点) | 283/300 (94.33%) | 再ラン待ち | 283/300 (94.33%) | 270/300 (90.00%) |
| 必修 (No-Img、175点) | 158/175 (90.29%) | 163/175 (93.14%) | 162/175 (92.57%) | 142/175 (81.14%) |
| 一般 (No-Img、208点) | 199/208 (95.67%) | 200/208 (96.15%) | 201/208 (96.63%) | 190/208 (91.35%) |

ブロック別正答率:

| ブロック | Kimi K2.6 | GLM-5.1 (No-Img) | V3.2 think_on | V3.2 think_off |
|---|---|---|---|---|
| 119A 一般 | 97.3% | 97.6% | 96.0% | 90.7% |
| 119B 必修 | 92.0% | 97.8% | 96.0% | 86.0% |
| 119C 一般 | 92.0% | 96.7% | 86.7% | 84.0% |
| 119D 一般 | 92.0% | 95.4% | 96.0% | 92.0% |
| 119E 必修 | 92.0% | 93.0% | 92.0% | 80.0% |
| 119F 一般 | 96.0% | 95.3% | **98.7%** | 93.3% |

**観察**:
- **DeepSeek V3.2 think_on Overall 469/500 (93.80%) で Kimi K2.6 vision (93.00%) を上回り**、Claude-Sonnet-4 (94.20%) 直下。No-Img Score 363/383 (94.78%) は Claude-Sonnet-4 と完全同点
- Kimi K2.6 Overall 465/500 (93.00%) — Claude-Sonnet-4 (94.20%) と DeepSeek-R1-0528 (92.20%) の間
- GLM-5.1 No-Img Score 363/383 (94.78%) も **Claude-Sonnet-4 と完全同点**、Acc 285/297 (95.96%) で +1.3pt 上回る (V3.2 think_on と完全同点)
- V3.2 think_on vs think_off: Overall +38点 (431→469)、必修で +25点 (161→186)、一般で +13点 — thinking 効果が必修問題で特に大きい
- GLM-5.1 の Overall 列は scope 修正 (skip → blind) のための再ラン待ち
...
| Task | GLM-5.1 | Kimi K2.6 | V3.2 think_on | V3.2 think_off |
|---|---|---|---|---|
| JCommonsenseQA (exact_match) | 0.977 | 0.979 | 0.979 | 0.920 |
| JEMHopQA (exact_match / char_f1) | 0.658 / - | 0.617 / 0.747 | 0.550 / 0.664 | 0.300 / 0.351 |
| JSQuAD (exact_match / char_f1) | 0.812 / - | 0.806 / 0.912 | 0.801 / 0.912 | 0.815 / 0.920 |
| MGSM-ja (math_equiv) | 0.432 | **0.904** | 0.884 | 0.872 |
...
| Task | GLM-5.1 ON | Kimi K2.6 ON | V3.2 ON | V3.2 OFF |
|---|---:|---:|---:|---:|
| jcommonsenseqa | 1.8 | 2.9 | 5.2 | 0.1 |
| jemhopqa | 3.3 | 5.1 | 5.7 | 0.2 |
| jsquad | 3.1 | 3.6 | 4.3 | 0.2 |
| mgsm | 3.1 | 5.6 | 4.9 | 0.1 |
| igakuqa | 7.5 | 13.6 | 9.6 | 0.2 |
| igakuqa119 | 7.3 | 16.3 | 15.4 | 0.1 |
| jmle2026 | 7.4 | 16.2 | 12.9 | 0.1 |
| jmmlu_med | 5.0 | 9.0 | 7.9 | 0.2 |
| crade | 8.7 | 18.1 | 13.9 | 0.2 |
| rrtnm | 7.4 | 15.0 | 12.1 | 0.2 |

### decode tok/s p50

| Task | GLM-5.1 ON | Kimi K2.6 ON | V3.2 ON | V3.2 OFF |
|---|---:|---:|---:|---:|
| jcommonsenseqa | 99.9 | 78.1 | 59.2 | 55.5 |
| jsquad | 111.5 | 78.0 | 69.4 | 89.7 |
| mgsm | 106.6 | 77.8 | 71.6 | 76.8 |
| igakuqa | 91.4 | 77.3 | 63.8 | 91.9 |
| igakuqa119 | 80.7 | 63.8 | 59.1 | 50.1 |
| jmle2026 | 93.0 | 63.9 | 56.1 | 38.6 |
| crade | 89.1 | 64.0 | 65.6 | 99.8 |
| rrtnm | 101.5 | 63.4 | 74.5 | 101.8 |
