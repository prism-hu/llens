...
| **GLM-5.1 (本検証 text-only)** | - | - | **366/382 (95.81%)** | **288/302 (95.36%)** |
...
| カテゴリ | Kimi K2.6 (vision) | GLM-5.1 (text-only) | 合否ライン |
|---|---|---|---|
| 必修 (B+E、200点満点) | 191/200 (95.50%) / acc 95/100 (95.00%) | — (画像問題未評価) | 160点 |
| 一般+臨床 (A+C+D+F、300点満点) | 289/300 (96.33%) | — | 224点 |
| 必修 (Text-only、168点) | 163/168 (97.02%) / acc 85/88 (96.59%) | 162/168 (96.43%) / acc 84/88 (95.45%) | — |
| 一般+臨床 (Text-only、214点) | 206/214 (96.26%) | 204/214 (95.33%) | — |

ブロック別正答率:

| ブロック | Kimi K2.6 | GLM-5.1 (Text-only) |
|---|---|---|
| 120A 一般 | 97.3% | **100.0%** |
| 120B 必修 | 96.0% | 95.4% |
| 120C 一般 | 93.3% | 93.8% |
...
- 必修・一般 とも合否ライン通過。120D 全問正解、E が 47/50 で最弱
- 必修(95.50%)が一般(96.33%)よりわずかに低く、難易度3点問題の取りこぼしが見えるが致命的ではない
- GLM-5.1 (text-only) Text-only Score 366/382 (95.81%) — Kimi K2.6 (96.60%) を **Text-only で 0.79pt 下回る** (IgakuQA119 と逆)
- Kimi K2.6 は 120D で全問正解 (画像問題が多い回でも完璧)、GLM-5.1 は 120A で全問正解
